...
import org.jetbrains.jps.incremental.storage.digest.HashProvider;
import org.jetbrains.jps.incremental.storage.digest.SHA1HashProvider;
import org.jetbrains.jps.incremental.storage.util.FileUtil;
import org.jetbrains.jps.incremental.storage.util.StringUtil;
...
public class TreeActualizer {
   ...
   */
  private String hashDirectory(final ProjectHashedFileTree tree,
                               final File dir,
   ...
   */
  public boolean actualize(final File projectRoot,
                           final ProjectHashedFileTree tree,
                           final String path,
