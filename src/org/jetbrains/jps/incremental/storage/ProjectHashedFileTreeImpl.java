...
import org.jetbrains.jps.incremental.storage.storage.PathToChildrenMapping;
import org.jetbrains.jps.incremental.storage.storage.PathToHashMapping;
...
public class ProjectHashedFileTreeImpl implements ProjectHashedFileTree {
    ...
    public ProjectHashedFileTreeImpl(File dataStorageDirectory) {
        hashes = new PathToHashMapping(new File(dataStorageDirectory, "hashes"));
